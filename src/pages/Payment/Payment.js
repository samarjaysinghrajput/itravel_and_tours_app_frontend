  ...
  (async () => {
    try {
      const { data } = await axios.get(
        `https://itravel-and-tours-backend.onrender.com/api/hotels/${id}`
      );
      console.log(`https://itravel-and-tours-backend.onrender.com/api/hotels/${id}`);
      setSingleHotel(data);
    } catch (err) {
      console.log(err);
    }
...
const handleConfirmBookingClick = async () => {
  ...
  const options = {
    key: "rzp_test_pOW8ZgCJLCbw1m",
    amount: totalPayableAmount * 100,
    currency: "INR",
    name: "iTravels And Tour",
    email: "samarjaysinghrajput@gmail.com",
    contact: "7224082408",
    ...
    <main className="payment-page d-flex justify-center">
      ...
      <div className="final-details d-flex direction-column gap-large">
        <div className="d-flex gap-sm">
          ...
          <div className="d-flex direction-column" style={{ marginLeft: '25px' }}>
        ...
        <div className="tag">
          ...
          <strong className="strong">iTravels And Tour</strong> cover
        </div>
